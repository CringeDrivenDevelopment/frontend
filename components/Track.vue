<template>
  <div class="w-full flex justify-between items-center rounded-lg cursor-pointer transition-colors hover:bg-indigo-300/10 p-2 group">
    <div class="flex items-center gap-3">
      <div class="rounded-lg w-13 h-13 relative">
      ...
      <div class="flex flex-wrap content-between">
        <div class="w-full flex gap-2 items-center">
          <span class="text-lg font-medium">{{ track.title.length > MAX_SYMBOLS ? track.title.substring(0, MAX_SYMBOLS) + "..." : track.title }}</span>
